  ...
  return (
    <div className="grid gap-6 mt-4 grid-cols-1 md:grid-cols-2">
      ...
      <div className="space-y-9 px-4 lg:px-0">
        <div>
          <h2 className="uppercase font-semibold text-[35px]">
            TAILORED SERVICES TO CORPORATE CLIENTS
          </h2>
